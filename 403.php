...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen flex items-center justify-center p-4">
  <div class="max-w-3xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden transform hover:scale-[1.02] transition-all duration-300">
    <div class="bg-gradient-to-r from-red-600 to-red-700 p-12 text-white text-center relative overflow-hidden">
      ...
      <h1 class="text-8xl font-extrabold mb-4 tracking-tighter">403</h1>
    ...
    <div class="bg-white p-12">
      <div class="text-center">
        <p class="text-gray-700 text-xl mb-8 leading-relaxed">Maaf, Anda tidak memiliki izin untuk mengakses halaman ini.</p>
        <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <a href="<?= base_url('dashboard.php') ?>" class="px-8 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-xl hover:from-red-700 hover:to-red-800 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1">
