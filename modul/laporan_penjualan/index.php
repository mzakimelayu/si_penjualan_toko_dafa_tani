                ...
                <table class="min-w-full divide-y divide-stone-200">
                    <thead class="bg-stone-50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Harga Satuan</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Qty</th>
                    ...
                    <tbody class="divide-y divide-stone-100">
                        ...
                        if(isset($_GET['filter'])) {
                            ...
                            $query = "SELECT p.tanggal, p.status_dihapus, p.no_faktur_penjualan, p.total, 
                                    pl.nama_pelanggan, pg.nama_lengkap as nama_lengkap_pengguna,
                                    pr.nama_produk as nama_barang, dp.jumlah as qty, dp.harga as harga_satuan, dp.subtotal
                                    FROM penjualan p
