<?php
    $judul_halaman = "Edit Satuan";
    
    include '../../cek_login.php';

    // Ambil data satuan berdasarkan ID
    $id_satuan = $_GET['id'];
    $query = "SELECT * FROM satuan WHERE id_satuan = '$id_satuan' AND status_dihapus = FALSE";
...
<?php include '../../layout/sidebar.php'; ?>
    ...
    <div class="p-6 animate-slide-fade">    
        ...
        <div class="bg-stone-100 rounded-lg p-6 shadow-md animate-scale">
            <h2 class="text-2xl font-semibold text-gray-700 mb-6">Edit Satuan</h2>
            ...
            <?php
                ...
                <div id="alert-message" class="mb-4 bg-gradient-to-r from-red-50 to-red-100 border-l-4 border-red-500 shadow-md p-4 rounded-lg animate-fade-in-down flex justify-between items-center transform transition-all duration-300 hover:scale-[1.02]" role="alert">
                    ...
                    <p class="font-medium text-red-700"><?php echo $_SESSION['satuan_eror']; ?></p>
                    </div>
            ...
            <form action="proses_edit.php" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div class="animate-smooth">
                        <label for="nama_satuan" class="block text-gray-700 mb-2">Nama Satuan</label>
                        <input type="text" id="nama_satuan" name="nama_satuan" required value="<?php echo $data['nama_satuan']; ?>"
