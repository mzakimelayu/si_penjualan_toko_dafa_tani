  ...
  <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-green-600">
    <div class="flex flex-col lg:flex-row items-center justify-between mb-8 animate-scale">
      <div class="text-center lg:text-left">
        <h2 class="text-3xl font-bold text-green-800 mb-2">Data Satuan</h2>
        <p class="text-gray-600">Kelola Data Satuan</p>      
      </div>
        ...
        if(isset($_SESSION['satuan_sukses'])) { ?>
          <div id="alert-message" class="mb-4 bg-gradient-to-r from-green-50 to-green-100 border-l-4 border-green-500 shadow-md p-4 rounded-lg animate-fade-in-down flex justify-between items-center transform transition-all duration-300 hover:scale-[1.02]" role="alert">
            <div class="flex items-center space-x-3">
              ...
              <p class="font-medium text-green-700"><?php echo $_SESSION['satuan_sukses']; ?></p>
            </div>
    ...
    <div class="mb-6">
      <div class="relative">
        <input type="text" id="searchInput" class="w-full pl-12 pr-4 py-3 bg-gray-50 rounded-lg border border-gray-300 focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all duration-200" placeholder="Cari satuan...">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
      <div class="overflow-x-auto">
        <table id="satuanTable" class="min-w-full divide-y divide-gray-200 animate-smooth">
          <thead>
            <tr class="bg-gradient-to-r from-green-50 to-green-100">
              <th class="px-4 py-4 text-xs font-semibold text-left cursor-pointer hover:bg-green-200 transition-colors duration-200" data-column="id_satuan">
...
<script>
  ...
  async function fetchData() {
      try {
          const response = await fetch('get_satuan.php');
          ...
          tr.innerHTML = `
              ...
              <td class="px-4 py-4 border-b border-gray-200">
                  <div class="flex justify-center gap-4">
                      <button title="Edit Data Satuan" onclick="editSatuan(${row.id_satuan})" class="bg-amber-50 text-amber-600 p-2 rounded-lg hover:bg-amber-100 transition-colors group relative">
                          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button title="Hapus Data Satuan" onclick="hapusSatuan(${row.id_satuan})" class="bg-rose-50 text-rose-600 p-2 rounded-lg hover:bg-rose-100 transition-colors group relative">
                          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
